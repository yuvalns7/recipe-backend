...
var create = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, area_model_1["default"].create({
                        name: name
                    })
                        .then(function (data) {
                        return data;
...
var clear = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, area_model_1["default"].deleteMany({})];
    });
}); };
var findByName = function (name) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, area_model_1["default"].findOne({ name: name }).exec()];
    });
}); };
exports["default"] = {
    create: create,
